defmodule PhxWeatherWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxWeatherWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxWeatherWeb.Gettext, "errors", msg, opts)
    end
  end
